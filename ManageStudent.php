...
<body>
    <div class="wrapper">
        ...
        <h1 style="text-align: center; color:white;"><br> Manage Student</h1><br><br><br>
        <h3>
        <?php
       ...
       $qry='SELECT college_id,student_name FROM student'; 
       //Execute query 
       ...
       echo '<center>
       <table border="6" style="width: 61%;color:white;">
       <tr>
       <th>College ID</th>
       <th>Name</th>
       <th>Manage</th>
    ...
    ?>
        ...
        <td> <a href="StudentUpdate.php?id=<?php echo $row['college_id'];?>"class="button">Update</a> 

        <a href="StudentDelete.php?id=<?php echo $row['college_id'];?>"class="button" >Delete</a> </td>
        </tr>
    <?php
       }
