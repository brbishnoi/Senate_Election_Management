...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="mid-containt" style="background-color: wheat;margin-top: -4px; height: 550px;">
    <div class="container">
        <div class="row">
        ...
        <?php
            ...
            $qry="SELECT * FROM notification WHERE serial_number='$serial_number'"; 
            //Execute query 
            ...
            if (isset($_POST['submit'])){ 
                ...
                $title=$_POST['title'];
                $detail=$_POST['detail'];
                 $qry="UPDATE notification SET serial_number='$serial_number',title='$title',detail='$detail' WHERE serial_number='$serial_number'";
                 $result=mysqli_query($link, $qry) ; 
            if($result)
            {?>
                <script>
                    alert("updated successfully")
                    window.location.href="ManageNotification.php";
                </script>
            <?php
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="">
                    ...
                    <p class="text-center">update the details</p>
                    <div class="form-group">
                        <input class="form-control" type="text" name="title" value="<?php echo $row['title'];?>">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" cols="30" rows="5" name="detail" ><?php echo $row['detail'];?></textarea>
                    </div>
                    <div class="form-group">
