...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="mid-containt" style="background-color: wheat;margin-top: -4px; height: 880px;">
        ...
        <?php
            ...
            if (isset($_POST['submit'])){ 
               ...
               move_uploaded_file($filetmp, $target);
                 ...
                 $qry="UPDATE candidate SET candidate_id='$total-$candidate_id',college_id='$college_id',candidate_name='$candidate_name',course='$course',branch='$branch',year='$year',email='$email',mobile_number='$mobile_number',image='$target' WHERE candidate_id='$id'";
                 $result=mysqli_query($link, $qry) ; 
            if($result)
            {?>
                <script>
                    alert("updated successfully")
                    window.location.href="ManageCandidate.php";
                </script>
            <?php
            }
           ...
           <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="candidate_id" value="<?php echo $row['candidate_id'];?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="college_id" value="<?php echo $row['college_id'];?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="candidate_name" value="<?php echo $row['candidate_name'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="phone" name="mobile_number" value="<?php echo $row['mobile_number'];?>">
                    </div>
                    <div class="form-group">
