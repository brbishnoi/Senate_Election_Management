...
if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1)
{
            ...
            if (isset($_POST['submit'])){ 
                ...
                {
                         $qry="UPDATE admin SET admin_password='$admin_password' WHERE employee_id='$employee_id'";
        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="admin_cpassword" placeholder="Confirm Password">
                    </div>
