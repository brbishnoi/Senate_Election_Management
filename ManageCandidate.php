...
<body>
    <div class="wrapper">
        ...
        <h1 style="text-align: center;color:white;"><br> Manage Candidate</h1><br><br><br>
        <h3>
        <?php
    ...
    ?>
        ...
        <td> <a href="CandidateUpdate.php?id=<?php echo $row['candidate_id'];?>"class="button">Update</a> 

        <a href="CandidateDelete.php?id=<?php echo $row['candidate_id'];?>" class="button">Delete</a> </td>
        </tr>
    <?php
       }
      echo '</table>
