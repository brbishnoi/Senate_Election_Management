...
if (isset($_POST['submit'])){ 
    ...
    $qry="INSERT INTO notification VALUES('NULL','$title','$detail')"; 
    //Execute query 
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="mid-containt" style="margin-top: -4px; height: 550px;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="">
                    <h2 class="text-center">Add Notification</h2>
                    <p class="text-center">fill the details</p>
                    <div class="form-group">
                        <input class="form-control" type="text" name="title" placeholder="Title">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" cols="30" rows="10" name="detail" placeholder="about notification"></textarea>
                    </div>
                    <div class="form-group">
