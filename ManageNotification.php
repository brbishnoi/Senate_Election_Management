...
<body>
    <div class="wrapper">
        ...
        <h1 style="text-align: center;"><br> Manage Notification</h1><br><br><br>
        <h3>
        <?php
    ...
    ?>
        ...
        <td> <a href="NotificationUpdate.php?serial_number=<?php echo $row['serial_number'];?>" class="button">Update</a> 

        <a href="NotificationDelete.php?serial_number=<?php echo $row['serial_number'];?>" class="button">Delete</a> </td>
        </tr>
    <?php
       }
