...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $qry="SELECT * FROM student WHERE college_id='$id'"; 
            //Execute query 
            ...
            if (isset($_POST['submit'])){ 
                ...
                $student_password=$_POST['student_password'];
                 $qry="UPDATE student SET college_id='$college_id',student_name='$student_name',email='$email',student_password='$student_password' WHERE college_id='$id'";
                 $result=mysqli_query($link, $qry) ; 
            if($result)
            {?>
                <script>
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="student_name" value="<?php echo $row['student_name']?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="email" value="<?php echo $row['email']?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="password" name="student_password" value="<?php echo $row['student_password']?>" required>
                    </div>
